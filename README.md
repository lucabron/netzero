...
Therefore, this website gives a view on the progress of each country on their path to carbon neutrality by 2050.</p>
...
Therefore, taking the change of CO2 emissions from 2015 to the last available data (currently 2024) and <em>linearly extrapolating</em> until 2050,
...
But for the goal of 1.5 degree celsius to be reached, global net-zero needs to be reached in 2050 <a href="https://www.ipcc.ch/sr15/chapter/spm/">according to the IPCC.</a>
...
<p>Full write-up, including the linear-extrapolation trade-offs and the carbon-neutrality vs. net-zero distinction, is on the <a href="https://lucabron.github.io/netzero/methodology.html">methodology page</a>.</p>
<hr>
<p><i><a href="https://en.wikipedia.org/wiki/List_of_parties_to_the_Paris_Agreement">* Iran, Libya and Yemen have signed but did not ratify it. The United States of America withdrew from the agreement in 2026.</a></i></p>
...
<p><a href="https://ourworldindata.org/co2-emissions">More CO2 visualisations</a><br>
<a href="https://eciu.net/netzerotracker">Each country's pledge</a><br>
